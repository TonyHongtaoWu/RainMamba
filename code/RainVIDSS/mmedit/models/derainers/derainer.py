...
class Derainer(BaseModel):
    ...
    def __init__(self,
        ...
        self.min_negative_distance_initial = 56
        self.num_samples = 10
    ...
    def sample_patches(self, input_tensor, gt, lq, patch_size=16, positive_range_initial=2, min_negative_distance_initial=64,
        ...
        min_negative_distance = int(max(min_negative_distance_initial * (decay_rate **progress_ratio), 48)) 
    ...
    def forward_train(self, lq, gt):
        ...
        # self.save_hilbert_curve_small_scale(hilbert_curve128)
        ...
        anchors, positives, negatives = self.sample_patches(output, gt, lq, patch_size=self.patch_size,
                                                    ...
                                                    num_samples=self.num_samples, overlap=True, step_counter_cl= self.step_counter)
