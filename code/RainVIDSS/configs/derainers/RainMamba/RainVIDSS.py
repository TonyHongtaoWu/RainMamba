...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='../data/rainVIDSS/train/rainy',
            gt_folder='../data/rainVIDSS/train/gt',
            pipeline=[
                dict(
    ...
    test=dict(
        type='SRFolderMultipleGTDataset',
        lq_folder="../data/rainVIDSS/val/rainy",
        gt_folder="../data/rainVIDSS/val/gt",
        pipeline=[
            dict(
                type='GenerateSegmentIndices',
                start_idx=0,
...
log_config = dict(
    interval=1000, hooks=[dict(type='TextLoggerHook', by_epoch=False), dict(type='TensorboardLoggerHook', log_dir='../experiment/logs/VIDSS/', by_epoch=False)])
visual_config = None
dist_params = dict(backend='nccl')
log_level = 'INFO'
work_dir = '../experiment/VIDSS/'
load_from = None
resume_from = None
workflow = [('train', 1)]
