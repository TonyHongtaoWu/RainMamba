    ...
    def __call__(self, results):
        ...
        lq_paths = [
            osp.join(lq_path_root, clip_name,
                     f'{self.filename_tmpl.format(idx)}.jpg')
            for idx in frame_list
        ]
        gt_paths = [osp.join(gt_path_root, clip_name, f'{frame_name}.jpg')]
...
class GenerateFrameIndices:
    ...
    def __call__(self, results):
        ...
        gt_path_root = results['gt_path']
        lq_path = [
            osp.join(lq_path_root, clip_name, f'{v:d}.jpg')
            for v in neighbor_list
        ]
        gt_path = [osp.join(gt_path_root, clip_name, f'{frame_name}.jpg')]
...
class GenerateSegmentIndices:
    ...
    def __call__(self, results):
        ...
        gt_path = [
            osp.join(gt_path_root, clip_name, f'{v:d}.jpg')
            for v in neighbor_list
        ]
