...
class GenerateFrameIndices:
    ...
    def __call__(self, results):
        ...
        gt_path_root = results['gt_path']
        lq_path = [
            osp.join(lq_path_root, clip_name, f'{v:06d}.png')
...
class GenerateSegmentIndices:
    ...
    def __init__(self, interval_list, start_idx=0, filename_tmpl='{:06d}.png'):
        self.interval_list = interval_list
        self.filename_tmpl = filename_tmpl
    ...
    def __call__(self, results):
        ...
        gt_path = [
            osp.join(gt_path_root, clip_name, f'{v:06d}.png')
            for v in neighbor_list
        ]
